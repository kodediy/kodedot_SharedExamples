...
// Color order and timing for WS2812B (used only when Adafruit NeoPixel backend active)
...
/* ---------- Speaker (I2S) ---------- */
// Speaker connected via I2S (see docs: Speaker)
#define SPK_I2S_SCK           38   // SCK / BCLK (shared with mic)
#define SPK_I2S_WS            45   // WS  / LRCLK (shared with mic)
#define SPK_I2S_DOUT          46   // Data output (SD)
